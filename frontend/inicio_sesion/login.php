                        ...
                        <form autocomplete="off" method="post" role="form">
                            ...
                            <div class="form-button">
                                <a href="#"style="text-decoration:none">
                                    <span class="name">Recuperar cuenta</span>
                                </a> 
                            </div>
                            <div class="form-button">
                                <a href="index.php?view=add_cuenta_proveedor" style="text-decoration:none">
                                    <span class="name"> Registrar cuenta</span>
                                </a>
                            </div>
                            <div class="form-button">
                                <a href="../index.php?view=add_cuenta_prospecto" style="text-decoration:none">
                                    <span class="name"> Registrar negocio</span>
                                </a>
                            </div>
